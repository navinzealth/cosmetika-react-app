...
import continueyoursearch from '../images/continue-your-search.png';
    ...
    return (
       ...
       <div className="row">
           <div className="col-md-12">
             <div className="heading-img"><img src={continueyoursearch} style={{'width':'308px'}} alt="img"/></div>
        </div>	
...
<>
                  <Slider {...settings}>
                    ...
                    {
                      initVal.homeData.continuesearch.map((item, i)=>(
        ...
        <div className="col-md-12">
          <div className="continue-your-search1-btn"><Link to={`/listing/${initVal.homeData.continueSearchAll.cat_slug}/${initVal.homeData.continueSearchAll.subcat_slug}`} className="explore-more">View All</Link></div>  
        </div>
</>
                )
              }
...
export default ContinueYourSearch
