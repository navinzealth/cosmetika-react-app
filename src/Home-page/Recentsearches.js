...
import continueyoursearch from '../images/recentsearches.png';
...
<>
                  <Slider {...settings}>
                    ...
                    {
                      initVal.homeData.recent.map((item, i)=>(
...
<div className="col-md-12">
          <div className="continue-your-search1-btn"><Link to={`/listing/${initVal.homeData.recentAll.cat_slug}/${initVal.homeData.recentAll.subcat_slug}`} className="explore-more">View All</Link></div>  
        </div>
</>
                )
              }
