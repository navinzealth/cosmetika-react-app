...
import continueyoursearch from '../images/more-to-explore.png';
...
<>
                  <Slider {...settings}>
                    ...
                    {
                      initVal.homeData.moretoexplore.map((item, i)=>(
...
<div className="col-md-12">
          <div className="continue-your-search1-btn"><Link to={`/listing/${initVal.homeData.moretoExploreAll.cat_slug}/${initVal.homeData.moretoExploreAll.subcat_slug}`} className="explore-more">View All</Link></div>  
        </div>
</>
                )
              }
